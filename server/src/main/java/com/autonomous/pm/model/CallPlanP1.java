...
@Slf4j
public class CallPlanP1 extends PmAssgn {
	...
	public CallPlanP1(PmAssgn pa) {
		...
		this.setCallTy(pa.getCallTy());		// CALL TY: 1=정지,2=재운행,3=회차,4=긴급배정
	...
	public String toString() {
	    return "CallPlanP1 [idCall="+this.getIdCall()+", idV="+this.getIdV()+", idGop="+this.getIdGop()+"leftRpt ="+this.getLeftRpt()+", term =" + this.getTerm()
    		+", callId="+this.getCallId()+", callTy="+this.getCallTy()+", csd="+this.getCsd()
